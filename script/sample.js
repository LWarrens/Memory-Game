...
(function(window) {
    ...
    Memory.prototype._renderTiles = function() {
        ...
        <div class="mg__tile--inner" txt = "' + this.newCards[i] + '">\
        <span class="mg__tile--outside"></span>\
        <span class="mg__tile--inside">\
        <span class="mg__tile--inside_text">' +
                this.newCards[i] + '</span></span>\
        </div>\
        </div>';
        }
        ...
        tile.addEventListener("click", function(e) {
            ...
            if (!this.classList.contains("flipped")) {
                if (self.card1flipped === false && self.card2flipped === false) {
                    ...
                    if (self.card1txt == self.card2txt) {
